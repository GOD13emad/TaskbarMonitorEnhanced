...
namespace TaskbarMonitorEnhanced
{
    ...
    {
        public const string Version = "V1_1_2_R21_PRODUCTION_HARDENING_RC9";
        public const string Product = "Taskbar Monitor Enhanced";
        public const string PublicVersion = "1.1.2-rc9";
