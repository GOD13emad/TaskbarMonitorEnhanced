...
LibreHardwareMonitor's current GPU implementation includes AMD, NVIDIA and Intel GPU groups. The 1.0.1 implementation should therefore use LHM as the cross-vendor fallback rather than treating `nvidia-smi` as the only GPU provider.
