...
The project is distributed under its upstream open-source license. Taskbar Monitor Enhanced v1.1.1 and the v1.1.2-rc4 R21 candidate use LibreHardwareMonitor 0.9.6 in the protected sensor backend.
