# Taskbar Monitor Enhanced v1.1.2-rc4 — R21 Production Hardening
...
- Live RC4 broker validation on the RTX 3080 produced valid power and fan telemetry; the CPU zero-watt false-positive found during testing was rejected by a >0.1 W validity guard.
...
RC4 promotion remains blocked on its transactional installed canary and then a longer soak that includes a real suspend/resume cycle; this RC is not yet declared Stable/Latest.
