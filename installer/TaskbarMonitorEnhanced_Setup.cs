...
internal static class SetupProgram
{
    ...
    const string Version="1.1.2-rc10";
    const string SensorLayerVersion="1.1.2-rc10+r21";
    ...
    static void WriteInstallState(SensorOutcome sensorOutcome)
    {
        ...
        string json="{\r\n"+
          ...
          "  \"PublicVersion\": \"1.1.2-rc10\",\r\n"+
          "  \"InternalRuntimeBaseline\": \"V1_1_2_R21_PRODUCTION_HARDENING_RC10\",\r\n"+
    ...
    static SensorOutcome Install(bool desktop,bool startup)
    {
        if(!Environment.Is64BitOperatingSystem)
            throw new InvalidOperationException("Taskbar Monitor Enhanced 1.1.2-rc10 requires 64-bit Windows.");
    ...
    static int Verify(string path)
    {
        try{
            ...
            if(!String.IsNullOrEmpty(path)){
                string json="{\"Status\":\"PASS\",\"Resources\":"+RequiredResources.Length+",\"Version\":\"1.1.2-rc10\",\"Publisher\":\"Dr. Ali-Akbar Emadeddin\",\"SensorArchitecture\":\"R21_PROCESS_ISOLATED\",\"SensorUpgradePolicy\":\"CURRENT_EXACT_ONLY_RC10\"}";
        ...
        public SetupForm()
        {
            ...
            install.Click+=delegate{
                ...
                try{
                    ...
                    if(outcome.IsHealthy){
                        MessageBox.Show(Product+" 1.1.2-rc10 was installed successfully.\r\n\r\nProtected hardware sensor monitoring is active.",
