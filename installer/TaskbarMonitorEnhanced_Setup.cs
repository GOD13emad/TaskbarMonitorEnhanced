...
internal static class SetupProgram
{
    ...
    const string Version="1.1.2-rc3";
    ...
    static void WriteInstallState(SensorOutcome sensorOutcome)
    {
        ...
        string json="{\r\n"+
          ...
          "  \"PublicVersion\": \"1.1.2-rc3\",\r\n"+
          "  \"InternalRuntimeBaseline\": \"V1_1_2_R21_PRODUCTION_HARDENING_RC3\",\r\n"+
    ...
    static SensorOutcome Install(bool desktop,bool startup)
    {
        if(!Environment.Is64BitOperatingSystem)
            throw new InvalidOperationException("Taskbar Monitor Enhanced 1.1.2-rc3 requires 64-bit Windows.");
    ...
    static int Verify(string path)
    {
        try{
            ...
            if(!String.IsNullOrEmpty(path)){
                string json="{\"Status\":\"PASS\",\"Resources\":"+RequiredResources.Length+",\"Version\":\"1.1.2-rc3\",\"Publisher\":\"Dr. Ali-Akbar Emadeddin\",\"SensorArchitecture\":\"R21_PROCESS_ISOLATED\"}";
            ...
            install.Click+=delegate{
                ...
                try{
                    ...
                    if(outcome.IsHealthy){
                        MessageBox.Show(Product+" 1.1.2-rc3 was installed successfully.\r\n\r\nProtected hardware sensor monitoring is active.",
